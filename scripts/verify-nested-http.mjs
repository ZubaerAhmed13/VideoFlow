...
try {
  ...
  const paths = [...precache, "./models/lama-512-int8.onnx", "./models/lama-512-int8.model.json", "./models/lama-dynamic-int8.onnx", "./models/lama-dynamic-int8.model.json", "./coi-bootstrap.js", "./service-worker.js"];
  const results = [];
